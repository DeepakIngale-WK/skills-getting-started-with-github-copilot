...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice team strategy and compete against other schools",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "nina@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Improve basketball skills and play friendly intramural games",
    ...
    "Drama Club": {
        "description": "Act in plays, practice stagecraft, and prepare performances",
